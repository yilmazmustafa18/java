...
public class  C02_LocalDateTime {
    public static void main(String[] args) {
        ...
        System.out.println("Ankara: "+dateTimeAnkara);

        LocalDateTime dateTimeUsaNewyork = LocalDateTime.now(ZoneId.of("America/New_York"));
        System.out.println("Newyork: "+dateTimeUsaNewyork); // 2024-08-08T13:36:56.706510

        System.out.println(Duration.between(dateTimeAnkara, dateTimeUsaNewyork));
